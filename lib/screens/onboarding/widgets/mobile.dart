...
class _MobileOnboardingScreenState extends State<MobileOnboardingScreen>
  ...
  setAnimationController() {
    ...
    _rotationAnimation = Tween<double>(begin: pi * 0.2, end: 0.0)
        .animate(curve(animationController!));
    runAnimation();
  }
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/imgs/shadow.png"),
                fit: BoxFit.cover,
              ),
            ),
          ),
            ...
            child: SizedBox(
              ...
              child: PageView.builder(
                ...
                onPageChanged: (page) async {
                  ...
                  Future.delayed(
                      const Duration(milliseconds: 500), () => runAnimation());
                },
                            ...
                            AnimatedBuilder(
                              ...
                              builder: (context, _) {
                                return Transform.rotate(
                                  ...
                                  child: Image.asset("assets/imgs/image_$i.png",
                                      scale: 4),
                                );
                              },
                            ),
