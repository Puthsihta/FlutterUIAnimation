...
class _CartScreenState extends State<CartScreen> {
  ...
  animateAction() {
    controller.animateTo(
      !isExpanded
          ? AppSizing.height(context) * 0.005
          : AppSizing.height(context) * 0.8,
      duration: duration,
      curve: curve,
    );
    setState(() {
  ...
  Widget bottomBar() {
    return Container(
      ...
      // color: Colors.amber,
      constraints:
          BoxConstraints(maxHeight: AppSizing.height(context), minHeight: 0),
                      ...
                      children: [
                        Transform(
                          ...
                          transform: Matrix4.identity()
                            ..translate(
                                (1 - scaleFactor).clamp(-20.0, 30.0), 0.0)
                            ..scale(2 - scaleFactor),
                          child: Padding(
                                ...
                                ...[2, 3, 4].map((index) {
                                  return Padding(
                                    ...
                                    child: CircleAvatar(
                                      radius: 18,
                                      child: Image.asset(
                                        "assets/imgs/shop_item_$index.png",
                                      ),
                                    ),
                                  );
                                }),
                        ...
                        ...ShoppingItem.data().map((item) {
                          return ListTile(
                            leading: CircleAvatar(
                              child: Image.asset(
                                  "assets/imgs/shop_item_${item.index}.png"),
                            ),
