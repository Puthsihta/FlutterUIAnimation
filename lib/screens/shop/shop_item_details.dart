...
import 'package:flutter_aninmation_ui/components/gradient_btn.dart';
import 'package:flutter_aninmation_ui/models/shop.model.dart';
import 'package:flutter_aninmation_ui/screens/shop/cart_screen.dart';
import 'package:flutter_aninmation_ui/themes/colors.dart';
import 'package:flutter_aninmation_ui/utils/helper.dart';
        ...
        child: TweenAnimationBuilder(
          ...
          builder: (context, value, child) {
            return Transform.translate(
                offset: value, child: bottomAddBar(context));
          },
        ),
      ),
                            ...
                            children: [
                              ...huddies.map((huddy) {
                                return Container(
                                  ...
                                  child: Image.asset(
                                    "assets/imgs/huddies_${huddy.index}.png",
                                    scale: 4.1,
                                  ),
                                );
                              }),
        ...
        Hero(
          ...
          child: Container(
            ...
            child: AnimatedScale(
              ...
              child: Image.asset(
                "assets/imgs/shop_item_${widget.item.index}.png",
                scale: 0.4,
              ),
            ),
          ),
