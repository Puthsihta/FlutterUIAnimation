...
import 'package:flutter_aninmation_ui/components/app_clipper.dart';
...
class _PizzaScreenState extends State<PizzaScreen>
  ...
  @override
  void initState() {
    heighController = AnimationController(duration: duration, vsync: this);
    bounceController =
        AnimationController(vsync: this, duration: bounceDuration);
    final curvedAnimation =
        CurvedAnimation(parent: heighController, curve: Curves.easeIn);
    final bounceAnimationCurve =
        CurvedAnimation(parent: bounceController, curve: Curves.elasticInOut);
    heightAnimation =
        Tween<double>(begin: 1, end: 0.7).animate(curvedAnimation);
    bounceAnimation =
        Tween<double>(begin: 1, end: 0).animate(bounceAnimationCurve);
    initialAnimation();
    super.initState();
  }
  ...
  animateTransition() {
    final bounceAnimationCurve =
        CurvedAnimation(parent: bounceController, curve: Curves.easeIn);
    bounceAnimation =
        Tween<double>(begin: 1, end: 0).animate(bounceAnimationCurve);
    bounceController.forward();
  }
      ...
      child: AnimatedBuilder(
          ...
          builder: (context, child) {
            return Transform.translate(
              offset: Offset(
                  0, bounceAnimation.value * AppSizing.height(context) * 0.5),
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      //     duration: miniDuration,
                      //     tween: ColorTween(
                      //       begin: cartItems.contains(pizzas[activeIndex])
                      //           ? AppColors.blue
                      //           : AppColors.primary,
                      //       end: cartItems.contains(pizzas[activeIndex])
                      //           ? AppColors.primary
                      //           : AppColors.blue,
                      //     ),
                      //     builder: (context, value, child) {
                      ...
                      //           fixedSize:
                      //               Size(AppSizing.width(context) * 0.25, 45),
                      //         ),
                      //         child: Text(
                      //           cartItems.contains(pizzas[activeIndex])
                      //               ? "Checkout"
                      //               : "Add",
                      //           style: TextStyle(
                      //             color: cartItems.contains(pizzas[activeIndex])
                      //                 ? AppColors.black
                      //                 : AppColors.white,
                      //             fontSize: 12,
                      //           ),
            ...
            builder: (context, value) {
              return Row(
                ...
                children: [
                  // Transform.translate(
                  //   offset: Offset(
                  //       bounceAnimation.value * AppSizing.width(context) * -0.3,
                  //       0),
                  //   child: circleAvatar(
                  ...
                  Transform.translate(
                    offset: Offset(
                        ...
                        bounceAnimation.value *
                            -AppSizing.height(context) *
                            0.3),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(pizzas[activeIndex].title,
                        ...
                        TweenAnimationBuilder(
                          ...
                          builder: (context, value, child) {
                            final factor =
                                previousIndex > activeIndex ? 30 : -30;
                            return Transform(
                              transform: Matrix4.identity()
                                ..translate(value * factor),
                              child: Opacity(
            ...
            children: [
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (c, i) {
                    return AnimatedScale(
                      ...
                      child: Hero(
                        tag: i,
                        child: Image.asset("assets/imgs/pizza_$i.png"),
                      ),
                    );
                  },
                ),
              ...
              Positioned(
                child: InkWell(
                  ...
                  child: SvgPicture.asset('assets/svgs/zoom.svg'),
                ),
              ),
            ],
          ),
        ...
        Container(
          ...
          child: Center(
            child: TweenAnimationBuilder(
              ...
              builder: (context, value, child) {
                final factor =
                    previousQuantity > pizzas[activeIndex].quantity ? -10 : 10;
                return Transform.translate(
              ...
              if (pizzas[activeIndex].quantity == 0) {
                setState(() {
                  cartItems.removeWhere(
                      (item) => item.index == pizzas[activeIndex].index);
                });
              }
            },
  ...
  Widget circleAvatar(
      {required Widget icon, Color? bgColor, Function()? onTap}) {
