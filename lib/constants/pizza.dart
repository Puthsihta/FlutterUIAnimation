...
List<Pizza> pizzas = [
  Pizza(
    index: 0,
    image: 'assets/imgs/margherita.png',
    title: 'Margherita',
  ...
  Pizza(
    index: 1,
    image: 'assets/imgs/pepperoni.png',
    title: 'Pepperoni',
  ...
  Pizza(
    index: 3,
    image: 'assets/imgs/bbq_chicken.png',
    title: 'BBQ Chicken',
  ...
  Pizza(
    index: 4,
    image: 'assets/imgs/hawaiian.png',
    title: 'Hawaiian',
  ...
  Pizza(
    index: 4,
    image: 'assets/imgs/meat_lovers.png',
    title: 'Meat Lovers',
    subtitle: 'Hearty and satisfying',
    description:
        'A meat lover\'s dream with sausage, ham, pepperoni, and bacon.',
    price: 12.99,
    quantity: 1,
  ),
];
